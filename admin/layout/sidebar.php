<div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
      ...
      <span class="fs-2">Sidebar</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto fs-5">
      <li class="nav-item">
        <a href="product.php" class="nav-link link-body-emphasis" aria-current="page">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
          ໜ້າຫຼັກ
        </a>
      </li>
      <li>
        <a href="manage_prod.php" class="nav-link link-body-emphasis">
    ...
    <div class="mb-1">
      ...
      <ul class="collapse" id="account-collapse">
        <a href="\store_online/index.php" class="btn btn-outline-danger">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#people-circle"></use></svg>
          LogOut
        </a>
      </ul>
